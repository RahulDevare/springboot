...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee getEmployee(int employeeId) {
		if(empMap.containsKey(employeeId)) {
			...
			log.warn("getEmployee() - Employee not found with Id: "+employeeId);
	...
	public boolean addEmployee(Employee employee) {
		if(empMap.containsKey(employee.getId())) {
			log.warn("addEmployee() - Employee already exist with Id: "+employee.getId());
	...
	public Employee updateEmployee(Employee employee) {
		if(empMap.containsKey(employee.getId())) {
			log.warn("updateEmployee() - Employee not found with Id: "+employee.getId());
	...
	public boolean deleteEmployee(int employeeId) {
		if(empMap.containsKey(employeeId)) {
			...
			log.warn("deleteEmployee() - Employee not found with Id: "+employeeId);
			throw new EmployeeNotFoundException("EMP-404","Employee not found with Id: "+employeeId);
		}
	}
}
